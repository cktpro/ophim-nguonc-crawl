...
@php
    $defaultBreadcrumbs = [
        ...
        'Crawler_Nguonc' => backpack_url('plugin/nguonc-crawler'),
    ];
...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <button class="btn btn-sm btn-primary" id="movies-get-handle">Lấy danh sáchs</button>
                            </div>
                            <textarea class="form-control" rows="5" name="link">https://phim.nguonc.com/api/films/the-loai/hoat-hinh</textarea>
                        ...
                        <div class="form-group col-6">
                            <button class="btn btn-primary btn-load_nguonc">Tải</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-8 steps d-none">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-secondary btn-previous">Trước</button>
                    <button class="btn btn-primary btn-process_nguonc">Tiếp</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $('.btn-load_nguonc').click(function(e) {
            ...
            const crawlPages = (current) => {
                if (current > to) {
                    ...
                    next(this)
                    $('.btn-load_nguonc').html('Tải');
                    isFetching = false;
                    return
                }
                $('.btn-load_nguonc').html(`Đang tải...: Page ${current}/${to}`);
            ...
            const crawlMultiLink = (arrLink, current) => {
                ...
                $('.btn-load_nguonc').html(`Đang tải...: Link ${current + 1}/${arrLink.length}`);
        ...
        $('.btn-process_nguonc').click(function() {
